...
type ServicesAction = { type: ActionTypes.ADD; payload: Service } | { type: ActionTypes.REMOVE; payload: string }
...
const ServicesReducer = (state: ServicesState, action: ServicesAction): ServicesState => {
  switch (action.type) {
