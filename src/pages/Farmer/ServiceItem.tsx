    ...
    <div className='p-4 mb-4 border rounded-md'>
      ...
      <div>
        <div className='inline-flex rounded-md shadow-sm' role='group'>
          ...
          <button
            type='button'
            className='px-4 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-r border-gray-200 rounded-r-lg hover:bg-red-500 hover:text-white focus:z-10 focus:text-blue-700 focus:ring-2 focus:ring-blue-700'
